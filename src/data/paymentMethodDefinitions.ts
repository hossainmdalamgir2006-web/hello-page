...
export const PAYMENT_METHOD_DEFINITIONS: PaymentMethodDefinition[] = [
  ...
  },
  {
    ...
    name_bn: "২চেকআউট",
    icon: "💳",
    default_logo: "/logos/2checkout.svg",
  ...
  },
  {
    ...
    name_bn: "পেওনিয়ার",
    icon: "💳",
    default_logo: "/logos/payoneer.png",
  ...
  // ─── Manual / Other Methods ───────────────────────────────────────────────────
  {
    ...
    icon: "🏦",
    default_logo: "/logos/bank-transfer.png",
